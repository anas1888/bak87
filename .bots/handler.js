...
if (media === 'audio')
this.sendMessage(id, { audio: { url: vn }, contextInfo:{ mentionedJid:[user], "externalAdReply": { "thumbnail": apii.data, "title": `「🌸┊مـرحـبـا┊🌸」`, "body": [wm, ' ' + wm + '😊', '🌟'].getRandom(), "previewType": "PHOTO", "thumbnailUrl": null, "showAdAttribution": true,  sourceUrl: [md, nna, yt, nn, tiktok].getRandom()}},  ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 })
...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 👑;;;\nFN:𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿\nORG:𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 👑\nTITLE:\nitem1.TEL;waid=+201063808608\nitem1.X-ABLabel:Alakreb-𝙈𝘿 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
*╯═━━━━━✦🌸✦━━━━━═⧈*`,
    ...
    if (msg) return conn.sendMessage(m.chat, {text: msg, contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363376982425324@newsletter', serverMessageId: '', newsletterName: '𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓' }, externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-MD`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, nna2, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })
}
